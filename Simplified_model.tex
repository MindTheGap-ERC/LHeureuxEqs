...
\begin{split}
\frac{\partial}{\partial_t} \hat{c_k} = & -W \frac{\partial}{\partial_x} \hat{c_k} + {1 \over \phi} \frac{\partial}{\partial_x}\left(\phi d_k \frac{\partial\hat{c_k}}{\partial_x} \right) + Da {(1 - \phi) \over \phi} (\delta - \hat{c_k}) \big(C_A (\Omega_{DA} - \nu_1 \Omega_{PA}) - \lambda C_C (\Omega_{PC} - \nu_2 \Omega_{DC})\big)
\end{split}
